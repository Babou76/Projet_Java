...
public class ViewFormVoiture {
    ...
    public ViewFormVoiture(CarModel carModel, CarView carView) {
        this.carModel = carModel;
        this.carView = carView;
    }
    public void showForm() {
        controllerVoitureResgister = new ControllerVoiture(); // Remplacez ControllerVoiture() par le constructeur approprié si nécessaire
    ...
    public ModelVoiture getVoitureFromInput() {
        ...
        double discount = Integer.parseInt(discountField.getText());

        return new ModelVoiture(marque, model, new Date(), category, prix, nombreSiege, transmission, specification, description, discount);
    }
    ...
    public void showEditCarForm(Car car) {
        carControllerModified = new CarController(carModel, carView, this);

        carController = new CarController(carModel, carView, this);
        ...
        discountField = new JTextField(String.valueOf(car.getDiscount()));
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            Car modifiedCar = new Car(brand, name, car.getDate(), category, pricePerDay,
                    numberOfSeats, transmission, specification, description, discount);
