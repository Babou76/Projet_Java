...
public class ControllerVoiture {
    ...
    private void enregistrerVoitureDansLaBaseDeDonnees(ModelVoiture voiture) {
        ...
        try (Connection conn = DriverManager.getConnection(Model.DB_URL, Model.USER, Model.PASS)) {
            String query = "INSERT INTO car (Car_brand, Car_name, Car_Date, Car_category, Car_PricePerday, Car_NbSeat, Car_transmission, Car_specification, Car_Description, Car_Discount) " +
                    "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?,?)";
            ...
            statement.setDouble(10, voiture.getDiscount());
